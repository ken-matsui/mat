...
mod tests {
    ...
    fn test_define_entities() {
        ...
        assert_eq!(
            ...
            Diagnostics {
                warnings: vec![Warning::UnusedEntity(Span::any())],
                errors: vec![],
            },
        );
        assert_eq!(
            ...
            Diagnostics {
                warnings: vec![Warning::UnusedEntity(Span::any())],
                errors: vec![Error::DuplicatedDef(Span::any(), Span::any())],
            },
        );
    }
    ...
    fn test_visit_expr() {
        assert_eq!(
            ...
            Diagnostics {
                warnings: vec![Warning::UnusedEntity(Span::any())],
                errors: vec![Error::UnresolvedRef(Span::any())],
            },
        );
        assert_eq!(
            LocalResolver::new().resolve(&mut Hir::from_defs(vec![
